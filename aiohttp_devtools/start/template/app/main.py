...
def reverse_url(context, name, **parts):
    ...
    :param parts: url parts to be passed to route.url_for(),
        if parts includes "query" it's removed and passed separately
    :return: url as generated by app.route[<name>].url_for(parts=parts, query=query)
    """
    app = context['app']
    ...
    if parts:
        kwargs['parts'] = parts
    return app.router[name].url_for(**kwargs)
